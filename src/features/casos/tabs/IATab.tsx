    ...
    <div className="flex flex-col gap-3">
      {mensajes.length === 0 && (
        <div className="rounded-[10px] border border-dashed border-border bg-surface p-5 text-center">
          ...
          <div className="mt-1.5 text-[13px] font-medium text-ink">TSADOQ IA de este caso</div>
          <div className="mt-1 text-[12px] text-mute2">
            Responde con los datos del caso, partes, plazos, historial y el contenido de los documentos PDF subidos.
          </div>
          <button
      ...
      <div className="mt-1 flex gap-2">
        <input
          ...
          placeholder="Pregunta algo sobre este caso o sus documentos…"
