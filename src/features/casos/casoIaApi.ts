...
export async function preguntarCasoIA(casoId: string, pregunta?: string, historial?: MensajeHistorial[]): Promise<string> {
  ...
  const res = await fetch(url, {
    ...
    body: JSON.stringify({ caso_id: casoId, pregunta, historial }),
  })
