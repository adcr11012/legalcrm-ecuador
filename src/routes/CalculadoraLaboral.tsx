...
import { calcularLiquidacion, type TipoTerminacion, type ResultadoLiquidacion } from '@/features/laboral/calculoLiquidacion'

const TIPO_LABEL: Record<TipoTerminacion, string> = {
