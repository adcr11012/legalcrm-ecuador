...
- Calculadora Laboral (menú lateral, /calculadora-laboral): calcula liquidación/finiquito según el Código del Trabajo de Ecuador — décimo tercero y cuarto (con opción de marcarlos como "mensualizados" si ya se pagan con el sueldo), vacaciones no gozadas, fondos de reserva, bonificación por desahucio (Art. 185) e indemnización por despido intempestivo (Art. 188, sobre el mejor sueldo histórico), más protecciones especiales (embarazo/lactancia, dirigente sindical, discapacidad). No aplica a sector público ni servicios profesionales/honorarios. Disponible para todos los roles. Los montos siempre salen de fórmulas fijas, nunca de una estimación de la IA.
